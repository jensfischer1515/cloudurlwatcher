...
<title>CloudUrlWatcher</title>
<meta name="keywords" content="cloud, site monitoring" />
<meta name="description" content="" />
<link href="/styles/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div id="header">
	<h1>CloudUrlWatcher</h1>
	<h2>by openended.de </h2>
</div>
<div id="menu">
	<ul>
		<li><a href="#">Home</a></li>
...
<div id="footer">
	<p>Copyright &copy; 2006 CloudUrlWatcher. Designed by <a href="http://www.freecsstemplates.org" class="link1">Free CSS Templates</a></p>
</div>
</body>
</html>
